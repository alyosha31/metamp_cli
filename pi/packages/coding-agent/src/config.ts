...
export function getPackageDir(): string {
	...
	const envDir = process.env.METAMP_PACKAGE_DIR;
	if (envDir) {
...
export const PACKAGE_NAME: string = pkg.name || "metamp";
export const APP_NAME: string = appConfigName || "metamp";
export const APP_TITLE: string = appConfigName ? APP_NAME : "metamp";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".metamp";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., METAMP_CODING_AGENT_DIR
...
const DEFAULT_SHARE_VIEWER_URL = "https://metamp.local/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.METAMP_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// =============================================================================
// User Config Paths (~/.metamp/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.metamp/agent/) */
